...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid=t'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';
  ...
  const msg={
      to: email,
      from: //"satviq0639.cse19@chitkara.edu.in",
...
function sendexmail(email,couth,coutm){
    const sgMail=require('satviq0639.cse19@chitkara.edu.in');
   const  sendgrid='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';
  sgMail.setApiKey(sendgrid);
